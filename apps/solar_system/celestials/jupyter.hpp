...
#ifndef SOLAR_SYSTEM_CELESTIALS_JUPYTER_HPP_INCLUDED
#define SOLAR_SYSTEM_CELESTIALS_JUPYTER_HPP_INCLUDED

#include <borov_engine/collision.hpp>
#include <borov_engine/geometric_primitive_component.hpp>

class Jupyter final : public borov_engine::SceneComponent, public borov_engine::Collision {
  public:
...
#endif  // SOLAR_SYSTEM_CELESTIALS_JUPYTER_HPP_INCLUDED
