...
class Neptune final : public borov_engine::SceneComponent, public borov_engine::Collision {
  public:
    explicit Neptune(borov_engine::Game &game, const Initializer &initializer = {});
