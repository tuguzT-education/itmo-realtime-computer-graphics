...
#ifndef SOLAR_SYSTEM_CELESTIALS_URANUS_HPP_INCLUDED
#define SOLAR_SYSTEM_CELESTIALS_URANUS_HPP_INCLUDED

#include <borov_engine/collision_primitive.hpp>
#include <borov_engine/geometric_primitive_component.hpp>

class Uranus final : public borov_engine::SceneComponent, public borov_engine::CollisionPrimitive {
  public:
    explicit Uranus(borov_engine::Game &game, const borov_engine::Transform &transform = {},
...
#endif  // SOLAR_SYSTEM_CELESTIALS_URANUS_HPP_INCLUDED
