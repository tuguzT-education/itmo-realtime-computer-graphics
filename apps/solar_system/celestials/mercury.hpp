...
#ifndef SOLAR_SYSTEM_CELESTIALS_MERCURY_HPP_INCLUDED
#define SOLAR_SYSTEM_CELESTIALS_MERCURY_HPP_INCLUDED

#include <borov_engine/collision_primitive.hpp>
#include <borov_engine/geometric_primitive_component.hpp>

class Mercury final : public borov_engine::SceneComponent, public borov_engine::CollisionPrimitive {
  public:
    explicit Mercury(borov_engine::Game &game, const borov_engine::Transform &transform = {},
...
#endif  // SOLAR_SYSTEM_CELESTIALS_MERCURY_HPP_INCLUDED
