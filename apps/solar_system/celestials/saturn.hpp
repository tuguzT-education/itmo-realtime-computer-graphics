...
class Saturn final : public borov_engine::SceneComponent, public borov_engine::CollisionPrimitive {
  public:
    explicit Saturn(borov_engine::Game &game, const borov_engine::Transform &transform = {},
