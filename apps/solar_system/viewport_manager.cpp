...
//
//    into.emplace_back(target_viewport.x, target_viewport.y,
//                      target_viewport.width / 2.0f, target_viewport.height,
//                      target_viewport.minDepth, target_viewport.maxDepth,
//                      target_viewport.camera);
//    into.emplace_back(target_viewport.x + target_viewport.width / 2.0f, target_viewport.y,
//                      target_viewport.width / 2.0f, target_viewport.height,
//                      target_viewport.minDepth, target_viewport.maxDepth,
//                      target_viewport.camera);
}
