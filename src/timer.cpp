...
void Timer::Tick() {
    ...
    if (const Duration time_from_previous_frame = current_ - previous_frame_; time_from_previous_frame > second) {
...
float Timer::SecondsFrom(const TimePoint time_point) const {
